...
- [ ] **Step 1: Replace overlay composition with direct image opacity**
...
- [ ] **Step 2: Remove call-site opacity overrides**
...
- [ ] **Step 3: Compile the ArkTS module**
...
- [ ] **Step 1: Delete the thumbnail subtree and import**
...
- [ ] **Step 2: Strengthen the remaining controls**
...
- [ ] **Step 3: Verify no thumbnail renderer remains**
...
- [ ] **Step 1: Restore automatic system-bar avoidance**
...
- [ ] **Step 2: Confirm only backgrounds expand into system areas**
...
- [ ] **Step 3: Compile with API 21 declarations**
...
- [ ] **Step 2: Run the final signed Debug build**
...
- [ ] **Step 4: Record device verification requirements**
